...
| **03** | [[03-navigating-public-benchmarks-and-pitfalls\|03. 공개 벤치마크 탐색과 4대 함정]] | 벤치마크 상관관계, 4대 함정(포화 Saturation, 데이터 오염 Contamination, 프롬프트 민감도 Prompt Sensitivity, 도메인 괴리 Lack of Domain Relevance) (pp. 191-199) | `Open LLM Leaderboard`, `Saturation`, `Contamination`, `Prompt Sensitivity`, `Domain Relevance` |
