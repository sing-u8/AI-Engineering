...
| **Table 8-4** | 프롬프트 엔지니어링 예제를 파인튜닝용 학습 데이터 포맷(음식 분류 태스크)으로 변환한 예시표 | **p. 402** | 4. 데이터 표준 포맷팅 |
...
예를 들어, 베이스 모델에서 사용하던 3-shot 프롬프트를 파인튜닝용으로 변환하면 다음과 같이 간결한 형태(Table 8-4)가 됩니다:

**[Table 8-4. 음식 분류 태스크를 위한 파인튜닝 학습 데이터 예시]**
